...
namespace ORM_Fundamentals.Models
{
    public partial class SoftUniContext : DbContext
    {
        ...
        public virtual DbSet<DepartmentIdAndAvgSalary> DepartmentIdAndAvgSalaries { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=DESKTOP-KQDB4SL\\SQLEXPRESS;Integrated Security=true;Database=SoftUni");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<DepartmentIdAndAvgSalary>(entity =>
            {
                entity.HasNoKey();

                entity.ToTable("DepartmentIdAndAvgSalary");

                entity.Property(e => e.AvarageSalary).HasColumnType("money");
